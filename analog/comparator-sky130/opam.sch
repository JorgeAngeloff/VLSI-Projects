...
N 360 -550 400 -550 {lab=VCC}
N 360 -730 410 -730 {lab=VCC}
N 360 -790 360 -760 {lab=VCC}
N 160 -550 200 -550 {lab=VCC}
...
N -350 -1070 -300 -1070 {lab=VCC}
N -350 -1130 -350 -1100 {lab=VCC}
...
N -400 -780 -390 -780 {lab=VCC}
N -350 -750 -350 -740 {lab=VSS}
N -350 -920 -300 -920 {lab=G1}
N -350 -980 -300 -980 {lab=VCC}
...
C {ipin.sym} -720 -640 0 0 {name=p4 lab=VCC
}
...
C {lab_pin.sym} -330 -610 0 0 {name=p9 sig_type=std_logic lab=VCC}
...
C {lab_pin.sym} -270 -430 0 0 {name=p15 sig_type=std_logic lab=VCC}
C {lab_pin.sym} -400 -430 0 1 {name=p16 sig_type=std_logic lab=VCC}
C {lab_pin.sym} -290 -550 0 1 {name=p17 sig_type=std_logic lab=VCC}
...
C {lab_pin.sym} 400 -550 0 1 {name=p22 sig_type=std_logic lab=VCC}
C {lab_pin.sym} 410 -730 0 1 {name=p24 sig_type=std_logic lab=VCC}
C {lab_pin.sym} 360 -790 0 1 {name=p25 sig_type=std_logic lab=VCC}
C {lab_pin.sym} 300 -730 0 0 {name=p26 sig_type=std_logic lab=EN_N}
C {lab_pin.sym} 160 -550 0 0 {name=p27 sig_type=std_logic lab=VCC}
...
C {lab_pin.sym} -300 -1070 0 1 {name=p32 sig_type=std_logic lab=VCC}
C {lab_pin.sym} -350 -1130 0 1 {name=p33 sig_type=std_logic lab=VCC}
...
C {lab_pin.sym} -400 -780 0 0 {name=p37 sig_type=std_logic lab=VCC}
...
C {lab_pin.sym} -300 -980 0 1 {name=p40 sig_type=std_logic lab=VCC}
