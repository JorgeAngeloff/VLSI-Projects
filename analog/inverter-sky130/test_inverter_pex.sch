...
C {code_shown.sym} 270 -150 0 0 {name=s1 only_toplevel=false value=".include ~/Documentos/proyectos_analogicos/test_xschem_sky130/Layout/inverter.spice
.lib /usr/local/share/pdk/sky130B/libs.tech/ngspice/sky130.lib.spice tt
.tran 0.1n 100n 
.save all
.control
  run
  write test_inverter_pex.raw
.endc"}
C {inverter.sym} 140 240 0 0 {name=x1}
C {launcher.sym} 490 450 0 0 {name=h5
descr="load waves"
tclcommand="xschem raw_read $netlist_dir/test_inverter_pex.raw tran"
}
